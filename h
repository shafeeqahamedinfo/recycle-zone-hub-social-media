    ...
    s fa-circle me-1"></i> Online Friends
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo isLoggedIn() ? 'index.php' : 'public.php'; ?>">
                    <i class="fas fa-users me-2"></i>Recycle Zone Hub <span class="text-muted small">- SocialConnect</span>
                </a>
                    ...
                    <?php if (isLoggedIn()): ?>
                        <div class="navbar-nav ms-auto">
                            ...
                            <a class="nav-link position-relative" href="online_friends.php">
                                ...
                                <?php if (isset($_SESSION['user_id']) && getOnlineFriendsCount($_SESSION['user_id']) > 0): ?>
                                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success">
                                        <?php echo getOnlineFriendsCount($_SESSION['user_id']); ?>
                                    </span>
                                <?php endif; ?>
